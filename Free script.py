...
Y='\033[1;93m'
logo = """
 _____ _____  _    _______ _____ _   __    ___________ 
|_   _|  _  || |  | |  ___|_   _| | / /   |___  /  _  |
  | | | | | || |  | | |_    | | | |/ /______ / / \ V / 
  | | | | | || |/\| |  _|   | | |    \______/ /  / _ \ 
  | | \ \_/ /\  /\  / |    _| |_| |\  \   ./ /  | |_| |
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 Towfik-78 ISLAM 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX TEACHER Towfik-78💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +1(213)778-0818👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-Towfik-78)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/Towfik-78Technologychannel')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[Towfik-78-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
